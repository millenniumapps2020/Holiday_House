                            ...
                            <div className="row">
                                ...
                                {propertyDetails.images.length > 0 ?
                                    ...
                                    <div className="decription-section">
                                        ...
                                        {propertyDetails.ratingDetails.length > 2 ?
                                            <div className="mt-3">
                                                <span class="breadcum-link" onClick={this.reviewViewChange}><i class={fullAmentiesView ? "fa fa-xs fa-minus" : "fa fa-xs fa-plus"}></i>View {fullAmentiesView ? "less" : "More"} </span>
                                            </div> : null}
                                    </div>
